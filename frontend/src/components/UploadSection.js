        ...
        <Status status={status} id={responseData}/>
            ...
            <div className="upload-submit-container">
                ...
                <div className={alert ? "upload-inputs-container show-warnings" : "upload-inputs-container"}>
                    ...
                    <p className={inputs.password.length<6 ? "warning-message" : "success-message"}>{inputs.password.length<4 ? "passowrd should have at least 6 characters" : "Password Acceptable"}</p>
                </div>
